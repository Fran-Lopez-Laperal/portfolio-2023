'use strict';
/* build-hook-start *//*00001*/try { require('/users/fran/.vscode/extensions/wallabyjs.console-ninja-0.0.199/out/buildhook/index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///users/fran/.vscode/extensions/wallabyjs.console-ninja-0.0.199/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
